...
interface BroadcasterMockupProps {
  isOpen: boolean;
  onClose: () => void;
  meetingId: string;
}

export const BroadcasterMockup = ({ isOpen, onClose, meetingId }: BroadcasterMockupProps) => {
  return (
    <motion.div
      initial={{ x: "-120%" }}
      ...
      className="fixed z-50
        ...
        /* Desktop: Bottom-left, scaled down */
    ...
    >
      ...
      <div className="relative w-full h-full bg-black md:rounded-[50px] shadow-2xl border-[8px] md:border-[12px] border-gray-900 overflow-hidden flex flex-col">
        ...
        <div className="w-full h-full bg-white md:rounded-[38px] overflow-hidden">
          <iframe
            src={`/meeting/${meetingId}/broadcast`}
