      ...
      const recordSegment = () => {
        ...
        try {
          ...
          const setupRecorder = (useDefault: boolean) => {
            const options = useDefault
              ...
              : mimeType
                ...
                : undefined;
            console.log(
              `[Broadcast] Creating recorder with: ${useDefault ? "default" : mimeType || "default"}`
            );
          ...
          try {
            ...
            console.warn(
              `[Broadcast] Preferred config failed, retrying with default`,
              err
            );
            ...
            try {
              ...
              throw new Error(
                `Recorder start failed: ${retryErr.message || String(retryErr)}`
              );
            }
          }
